...
export const metadata: Metadata = {
  title: "Giới thiệu",
  description:
    "Tổng quan về TAKO Vietnam, bối cảnh hình thành doanh nghiệp, định hướng công nghệ sinh học và các nhóm giải pháp trong y sinh phân tử.",
};
    ...
    <div className="section-shell py-12 sm:py-16">
      ...
      <section className="grid gap-6 py-16 lg:grid-cols-3">
        {strategicContext.map((value) => (
          <article key={value.title} className="panel px-6 py-6">
            <div className="text-xs uppercase tracking-[0.22em] text-[var(--color-primary)]">Nền tảng chiến lược</div>
      ...
      <section className="panel grid gap-8 px-6 py-8 lg:grid-cols-[0.95fr_1.05fr] lg:px-8">
        <div className="space-y-4">
          <span className="eyebrow">Năng lực doanh nghiệp</span>
